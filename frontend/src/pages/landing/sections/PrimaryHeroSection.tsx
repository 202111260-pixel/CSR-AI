...
/* ─────────────────────────────────────────────
   8 CSR collage images — /public/ root
───────────────────────────────────────────── */
const CSR_IMAGES = [
  '/card-analytics.jpeg',   // pie chart + hands
  '/card-0.jpeg',           // globe + location pins
  '/card-ai-team.jpeg',     // AI robot + woman
  '/card-growth.jpeg',      // coins + plants growth chart
  '/card-finance.jpeg',     // hand holding coin stack
  '/card-insights.jpeg',    // AI faces + lightbulb
  '/card-analyst.jpeg',     // woman + laptop + data
  '/card-economy.jpeg',     // hand + cash + city skyline
];
...
export function PrimaryHeroSection() {
  return (
    ...
    >
      ...
      >
        A platform to manage<br />
        <span style={{ color: G, fontWeight: 700 }}>your CSR</span> masterpiece.
      </motion.h1>
      ...
      >
        Track CSR project lifecycle, budgets, beneficiaries, and impact<br />
        across Oman's 11 governorates — powered by AI.
      </motion.p>
