...
const stats = [
  { value: '115+',   label: 'API Endpoints' },
  { value: '22',     label: 'Data Models' },
  { value: '11',     label: 'Governorates' },
  { value: '24',     label: 'App Pages' },
  { value: '96/100', label: 'Maturity Score' },
];
...
const CARDS = [
  ...
  },
  {
    ...
    content: (
      <div style={{ background: '#111', border: '1px solid rgba(139,92,246,0.3)', borderRadius: 12, padding: '10px 14px', width: 140 }}>
        <p style={{ color: 'rgba(167,139,250,0.65)', fontSize: 10, marginBottom: 6 }}>Active Projects</p>
  ...
  },
  {
    ...
    content: (
      <div style={{ background: '#111', border: '1px solid rgba(139,92,246,0.3)', borderRadius: 12, padding: '10px 14px', width: 148 }}>
        <p style={{ color: 'rgba(167,139,250,0.65)', fontSize: 10, marginBottom: 6 }}>Beneficiaries</p>
        <p style={{ color: '#fff', fontSize: 26, fontWeight: 800, lineHeight: 1 }}>2,847</p>
        <p style={{ color: 'rgba(167,139,250,0.45)', fontSize: 10, marginTop: 4 }}>11 governorates</p>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <div style={{ background: '#111', border: '1px solid rgba(139,92,246,0.3)', borderRadius: 12, padding: '10px 14px', width: 148 }}>
        ...
        <p style={{ color: '#fff', fontSize: 13, fontWeight: 700 }}>48 teams active</p>
        <p style={{ color: 'rgba(167,139,250,0.45)', fontSize: 10 }}>↗ this quarter</p>
      </div>
    ),
  },
];

/* ── Video — plays once on scroll into view ── */
        ...
        <div style={{
          ...
          >
            ...
            <div style={{
              ...
              <span style={{ color: '#c4b5fd', fontSize: 12, fontWeight: 600 }}>AI-Powered CSR Management</span>
            </div>
            ...
            <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 16, lineHeight: 1.7, maxWidth: 460, marginBottom: 36 }}>
              Track project lifecycles, monitor budgets, measure impact, and leverage
              AI-powered insights — all across Oman's 11 governorates in one platform.
            </p>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 28, flexWrap: 'wrap' }}>
              ...
              <div style={{ position: 'relative', display: 'flex', flexDirection: 'column' }}>
                ...
                <span style={{ fontFamily: "'Caveat', cursive", color: '#4ade80', fontWeight: 700, fontSize: 17, lineHeight: 1.55 }}>Real projects.</span>
                <span style={{ fontFamily: "'Caveat', cursive", color: '#4ade80', fontWeight: 700, fontSize: 17, lineHeight: 1.55 }}>Real impact.</span>
                <span style={{ fontFamily: "'Caveat', cursive", color: '#4ade80', fontWeight: 700, fontSize: 17, lineHeight: 1.55 }}>Real growth.</span>
              </div>
            </div>
          </motion.div>
