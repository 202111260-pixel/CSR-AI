...
export function GlassCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'relative rounded-2xl border border-[#1A2D48]/60 bg-[#0A1525]/60 p-6 backdrop-blur-xl transition-colors duration-300',
        hover && 'cursor-pointer hover:border-[#C8A44E]/30 hover:bg-[#0F1D32]/70',
        className,
      )}
    >
      {glow && (
