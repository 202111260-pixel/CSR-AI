...
const Skeleton = () => {
  ...
  useEffect(() => {
    // @ts-ignore - motion animate sequence typing
  ...
  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      ...
      {/* Blue horizontal scanning line with dots */}
      <motion.div
        className="absolute z-40"
        style={{ top: '50%', marginTop: -1, left: 0, width: 2, height: 2 }}
        animate={{ x: ['-8px', '110%'] }}
      ...
      >
        ...
        <div
          style={{
            ...
            width: '120px',
            height: 2,
            background: 'linear-gradient(to right, transparent, rgba(96,165,250,0.9) 30%, #3b82f6 50%, rgba(96,165,250,0.9) 70%, transparent)',
            boxShadow: '0 0 8px 3px rgba(59,130,246,0.5)',
          }}
        />
        {/* Dots */}
        {[-36, -18, 0, 18, 36].map((offset, i) => (
          <div
            ...
            style={{
              ...
              boxShadow: `0 0 ${i % 2 === 0 ? 10 : 7}px ${i % 2 === 0 ? 4 : 3}px rgba(59,130,246,0.8)`,
            }}
          />
        ))}
      </motion.div>
...
const Card = ({ className, children }: { className?: string; children: ReactNode }) => (
  <div
    className={cn(
      'w-full h-full rounded-[18px] border border-white/10 bg-[rgba(40,40,40,0.70)] shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group overflow-hidden flex flex-col',
      className
    )}
  >
    {children}
...
const CardTitle = ({ children, className }: { children: ReactNode; className?: string }) => (
  <h3 className={cn('text-[15px] font-semibold text-white px-5 pt-3 pb-1', className)}>
    {children}
  </h3>
);

const CardDescription = ({ children, className }: { children: ReactNode; className?: string }) => (
  <p className={cn('text-[12px] font-normal text-neutral-400 px-5 pb-4 leading-relaxed', className)}>
    {children}
  </p>
);
...
const CardSkeletonContainer = ({
  ...
  <div
    className={cn(
      'h-[15rem] rounded-xl z-40 flex-1',
      className,
      showGradient && 'bg-[rgba(40,40,40,0.70)] [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]'
    )}
  >
    {children}
  </div>
...
const MetaIconOutline = ({ className }: { className?: string }) => (
  ...
  >
    <defs>
      <linearGradient id="lg1" x1="62.34" y1="101.45" x2="260.34" y2="91.45" gradientTransform="matrix(1,0,0,-1,0,192)" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="#0064e1" />
        <stop offset="0.4" stopColor="#0064e1" />
        <stop offset="0.83" stopColor="#0073ee" />
        <stop offset="1" stopColor="#0082fb" />
      </linearGradient>
      <linearGradient id="lg2" x1="41.42" y1="53" x2="41.42" y2="126" gradientTransform="matrix(1,0,0,-1,0,192)" gradientUnits="userSpaceOnUse">
