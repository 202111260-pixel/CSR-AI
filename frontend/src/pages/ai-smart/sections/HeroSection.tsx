    ...
    <div style={{ position: 'relative', width: '100%', maxWidth: W, margin: '0 auto', height: H }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 6 }}>
          ...
          <div>
            <div style={{ fontSize: 10, fontWeight: 700, color: '#1A201A' }}>Early Warning</div>
            <div style={{ fontSize: 9, color: 'rgba(26,32,26,0.4)' }}>Budget threshold</div>
          </div>
        </div>
        {/* Mini progress bar */}
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 4 }}>
          <span style={{ fontSize: 9, color: 'rgba(26,32,26,0.4)' }}>Al Batinah Project</span>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 7 }}>
          ...
          <div>
            <div style={{ fontSize: 10, fontWeight: 700, color: '#1A201A' }}>AI Report Generated</div>
            <div style={{ fontSize: 9, color: 'rgba(26,32,26,0.4)' }}>Impact analysis · Q1 2026</div>
          </div>
        </div>
        {/* Mini bar chart */}
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
          {[
            { value: '2,847+', label: 'Beneficiaries' },
            { value: '44+', label: 'Active Projects' },
            { value: 'OMR 2M+', label: 'Budget Managed' },
          ].map((stat, i) => (
        ...
        <h2 style={{
          ...
          We Power The Best CSR Programs In Oman
        </h2>
...
export function HeroSection() {
  return (
    <section className="relative flex flex-col overflow-hidden" style={{ minHeight: '100vh' }}>
      ...
      {/* Arc Stats */}
      <div className="relative z-10 flex-1 flex items-end justify-center pb-2 px-4">
        <CSRArcStats />
      </div>

      {/* Globe */}
      <div className="relative flex items-center justify-center">
        <div className="relative h-60 w-full flex items-center justify-center md:h-60">
...
function Globe({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      onRender: (state: Record<string, number>) => { state.phi = phi; phi += 0.01; },
    });
