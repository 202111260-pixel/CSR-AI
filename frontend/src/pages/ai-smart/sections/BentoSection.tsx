        ...
        >
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 32, position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ ...SANS, color: 'rgba(255,255,255,0.3)', fontSize: 13, lineHeight: 1.7, maxWidth: 280 }}>
                  Projects tracked across every region of Oman — from Muscat to Dhofar, with real-time impact mapping.
                </p>
                {/* Small region pills */}
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginTop: 16 }}>
                  {['Muscat', 'Dhofar', 'Ad Dakhiliyah', 'Al Batinah', 'Ash Sharqiyah'].map(r => (
                    <span key={r} style={{
                      ...MONO,
                      fontSize: 9,
                  ...
                  <span style={{ ...MONO, fontSize: 9, color: AMBER_D, padding: '3px 4px' }}>+6 more</span>
                </div>
              </div>
            </div>
          </BentoCard>
          ...
          <BentoCard delay={0.2} style={{ gridColumn: 'span 5', minHeight: 280, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <p style={{ ...SANS, color: 'rgba(255,255,255,0.3)', fontSize: 13, lineHeight: 1.7, margin: '0 0 20px' }}>
                14 AI models analyze your data to surface risks, forecast outcomes, and recommend actions — in Arabic & English.
              </p>
            </div>
            <div style={{ position: 'relative', zIndex: 1 }}>
              {/* AI insight cards preview */}
              {[
                { text: 'Budget overrun risk detected in 3 projects', color: AMBER },
                { text: 'SDG Goal 4 alignment increased by 12%', color: TEAL },
                { text: 'Q2 beneficiary target on track — 94% achieved', color: '#a78bfa' },
              ].map((insight, i) => (
                <motion.div
                  key={i}
          ...
          <BentoCard delay={0.25} style={{ gridColumn: 'span 3', minHeight: 220, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
            ...
            <p style={{ ...SANS, color: 'rgba(255,255,255,0.3)', fontSize: 11.5 }}>
              Track alignment with<br />UN Sustainable Goals
            </p>
          </BentoCard>
          ...
          <BentoCard delay={0.3} style={{ gridColumn: 'span 5', minHeight: 220 }}>
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <p style={{ ...SANS, color: 'rgba(255,255,255,0.3)', fontSize: 13, lineHeight: 1.7, marginBottom: 18 }}>
                AI-triggered alerts for budget overflows, timeline delays, and quality drops before they become critical.
              </p>
              {/* Mini risk sparkline */}
              <MiniSparkline />
            </div>
          ...
          <BentoCard delay={0.2} style={{ gridColumn: 'span 5', padding: 0, background: 'none', border: 'none', borderRadius: 0 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, height: '100%' }}>
              ...
              <div style={{ ...cardBase, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: 24 }}>
                ...
                <p style={{ ...CAVEAT, color: 'rgba(255,255,255,0.4)', fontSize: 17, margin: 0 }}>Partners & Donors</p>
              </div>
              ...
              <div style={{ ...cardBase, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: 24 }}>
                ...
                <p style={{ ...CAVEAT, color: 'rgba(255,255,255,0.4)', fontSize: 17, margin: 0 }}>Ideas Submitted</p>
              </div>
            </div>
          </BentoCard>
          ...
          <BentoCard delay={0.35} style={{
            ...
            <div>
              <p style={{ ...SANS, color: '#fff', fontSize: 20, fontWeight: 700, margin: '0 0 6px' }}>
                Ready to transform your CSR?
              </p>
              <p style={{ ...SANS, color: 'rgba(255,255,255,0.35)', fontSize: 13, margin: 0 }}>
                Join organizations already making an impact across Oman.
              </p>
            </div>
            <Link
              to="/register"
